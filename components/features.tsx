...
export function FeaturesSection() {
  const features = [
    {
      title: "Seamless Web Map Integration",
      description:
    ...
    {
      title: "Watch Our DEMO On YouTube",
      description:
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p className=" max-w-9xl font-semibold mb-4 mx-auto text-left tracking-tight text-black dark:text-white text-xl md:text-2xl md:leading-snug">
      {children}
    </p>
  );
};
...
export const SkeletonThree = () => {
  return (
    <Link
      href="https://www.youtube.com/playlist?list=PLC0g-mJ78zx4AsSvo-N8tSPrhOYPn_w_0"
      target="__blank"
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          ...
          <Image
            src="https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726589675/vistaar/1694075172_isro-1_n5gdna.jpg"
            alt="header"
            width={800}
            height={800}
...
export const SkeletonTwo = () => {
  const images = [
    "https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726587818/vistaar/frame80_g3rbod.jpg",
    "https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726587812/vistaar/frame73_e3lmnq.jpg",
    "https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726587805/vistaar/frame61_vayt51.jpg",
    "https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726587800/vistaar/frame55_mmegpk.jpg",
    "https://res.cloudinary.com/dcwsgwsfw/image/upload/v1726587796/vistaar/frame31_b60cqs.jpg",
  ];
  const imageVariants = {
    whileHover: {
      scale: 1.1,
  ...
  return (
    <div className="relative flex flex-col items-start p-8 gap-10 h-full overflow-hidden">
      {/* TODO */}
      <div className="flex flex-row -ml-20 -mr-20 mt-10">
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">
      <Globe className="absolute  lg:-left-3 sm:-right-10 md:-right-10 -bottom-80 -top-5 md:-bottom-72" />
    </div>
  );
};
